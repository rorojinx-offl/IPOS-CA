...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>user.FULL_NAME</code>.
     */
    public final TableField<UserRecord, String> FULL_NAME = createField(DSL.name("FULL_NAME"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<UniqueKey<UserRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USER__UK_USER_1_117708238);
    }
